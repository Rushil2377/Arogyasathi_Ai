...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "24×7 AI-powered healthcare for rural India: symptom guidance, disease detection, report analysis, expert consultation." },
    ],
  }),
  component: Home,
});
...
const features = [
  { icon: Bot, title: "AI Health Assistant", desc: "Symptom analysis & 24×7 guidance in your language.", points: ["Symptom analysis", "Healthcare guidance", "24×7 support"], to: "/ai-health-assistant" },
  { icon: ScanLine, title: "Disease Detection", desc: "Upload an image, get an AI-powered prediction in seconds.", points: ["Skin disease detection", "Eye infection detection", "Instant prediction"], to: "/disease-detection" },
  { icon: FileText, title: "Medical Report Analyzer", desc: "Turn complex lab reports into plain-language insights.", points: ["Simplified explanations", "Abnormal value detection", "Risk insights"], to: "/report-analysis" },
  { icon: Stethoscope, title: "Expert Doctor Consultation", desc: "Connect to specialists with an AI-prepared summary.", points: ["Verified specialists", "AI patient summary", "Faster consultation"], to: "/report-analysis" },
];

const innovations = [
  { icon: Languages, title: "Multilingual Support", desc: "English, Hindi, Gujarati — speak naturally in your language." },
  { icon: BrainCircuit, title: "AI Disease Detection", desc: "Vision models trained on medical imaging for instant predictions." },
  { icon: Mic, title: "Voice + Text Interaction", desc: "Talk or type — accessible for elderly and low-literacy users." },
  { icon: FileText, title: "Report Summarization", desc: "Turn 10-page lab reports into a 1-paragraph summary." },
  { icon: Stethoscope, title: "Expert Consultation", desc: "Bridge patients to specialists with verified credentials." },
];
...
const testimonials = [
  { name: "Dr. Meera Shah", role: "General Physician, Ahmedabad", text: "ArogyaSathi's AI summaries cut my consultation prep time in half." },
  { name: "Rahul Patel", role: "Patient, rural Gujarat", text: "I uploaded my blood report in Gujarati and finally understood what it meant." },
  { name: "Anjali Verma", role: "ASHA worker", text: "The disease detection helps me triage skin conditions in remote villages." },
  { name: "Dr. Imran Khan", role: "Dermatologist", text: "Surprisingly accurate first-pass predictions. A real productivity tool." },
  { name: "Priya N.", role: "Caregiver", text: "My mother chats with the assistant in Hindi every morning. Game changer." },
];
  ...
  return (
    <PageShell>
      ...
      <section className="relative px-4 sm:px-6 pt-6 pb-24">
        <div className="mx-auto max-w-7xl grid lg:grid-cols-2 gap-10 items-center">
          <div>
            ...
            >
              AI-powered healthcare assistance available 24×7 for symptom guidance,
              disease detection, medical report understanding, and expert consultation.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 16 }}
              animate={{ opacity: 1, y: 0 }}
      ...
      <section id="about" className="px-4 sm:px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <Reveal className="text-center max-w-2xl mx-auto">
            <span className="text-xs font-bold tracking-[0.2em] text-medical-light uppercase">The problem</span>
            <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-medical-dark">Rural India deserves better healthcare</h2>
            <p className="mt-3 text-muted-foreground">
              900 million Indians live outside major cities. They face long travel,
              specialist shortages, confusing reports, and dangerously delayed diagnoses.
            </p>
          </Reveal>

          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <Reveal className="glass rounded-3xl p-7 hover-lift">
              <h3 className="font-display text-lg font-bold text-medical-dark mb-4">The challenges</h3>
              <ul className="space-y-3 text-sm">
                {["Travel of 50+ km to reach a specialist", "1 doctor per 1,500 people in rural areas", "Lab reports written in inaccessible jargon", "Critical diagnosis delayed by weeks"].map((c) => (
            ...
            <Reveal delay={0.1} className="rounded-3xl p-7 gradient-medical text-white hover-lift">
              ...
              <ul className="space-y-3 text-sm">
                {["AI assistant in 3+ languages, available 24×7", "On-device disease detection from a phone photo", "Reports explained in plain Hindi/Gujarati/English", "Direct consult with verified specialists"].map((c) => (
                  <li key={c} className="flex gap-3">
      ...
      <section id="features" className="px-4 sm:px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <Reveal className="text-center max-w-2xl mx-auto">
            <span className="text-xs font-bold tracking-[0.2em] text-medical-light uppercase">Core features</span>
            <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-medical-dark">Everything you need to stay healthy</h2>
          </Reveal>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <ul className="mt-4 space-y-1.5">
                      {f.points.map((p) => (
                        <li key={p} className="flex items-center gap-2 text-xs text-medical-dark/80">
      ...
      <section className="px-4 sm:px-6 py-20">
        <div className="mx-auto max-w-5xl">
          <Reveal className="text-center max-w-2xl mx-auto">
            <span className="text-xs font-bold tracking-[0.2em] text-medical-light uppercase">Innovation</span>
            <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-medical-dark">What sets us apart</h2>
          </Reveal>
            ...
            <div className="space-y-8">
              {innovations.map((it, i) => (
                <Reveal key={it.title} delay={i * 0.06}>
                  <div className={`flex sm:items-center gap-5 ${i % 2 === 0 ? "sm:flex-row" : "sm:flex-row-reverse"}`}>
      ...
      <section className="px-4 sm:px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <Reveal className="text-center max-w-2xl mx-auto">
            <span className="text-xs font-bold tracking-[0.2em] text-medical-light uppercase">Impact</span>
            <h2 className="mt-2 text-3xl sm:text-4xl font-bold text-medical-dark">Who we serve & how it helps</h2>
          </Reveal>
          <div className="mt-12 grid md:grid-cols-2 gap-6">
            <Reveal className="glass rounded-3xl p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="h-10 w-10 rounded-xl gradient-medical text-white flex items-center justify-center"><Users className="h-5 w-5" /></div>
            ...
            <Reveal delay={0.1} className="glass rounded-3xl p-7">
              <div className="flex items-center gap-3 mb-5">
                <div className="h-10 w-10 rounded-xl gradient-medical text-white flex items-center justify-center"><TrendingUp className="h-5 w-5" /></div>
      ...
      <section className="px-4 sm:px-6 py-20">
        <div className="mx-auto max-w-7xl">
          <Reveal className="text-center max-w-2xl mx-auto">
            <span className="text-xs font-bold tracking-[0.2em] text-medical-light uppercase">Roadmap</span>
