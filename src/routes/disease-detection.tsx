            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Upload an image of skin, eye, or visible symptom for an AI-powered prediction.
                </p>
              </div>
            </div>
          </Reveal>
                ...
                {result && !analyzing && (
                  ...
                  >
                    ...
                    <div className="mt-6 grid sm:grid-cols-2 gap-5">
                        ...
                        <ul className="space-y-2">
                          {result.symptoms.map((s) => (
                            <li key={s} className="flex gap-2 text-sm text-muted-foreground">
                              <span className="mt-1 h-1.5 w-1.5 rounded-full bg-medical-dark shrink-0" />
                              {s}
                            </li>
                          ))}
                        </ul>
                      ...
                      <div>
                        <h4 className="flex items-center gap-2 font-semibold text-medical-dark text-sm mb-3">
                          <ShieldCheck className="h-4 w-4 text-medical-light" /> Recommended
                          precautions
                        </h4>
                        <ul className="space-y-2">
                    ...
                    <div className="mt-6 p-4 rounded-2xl bg-medical-tint text-xs text-medical-dark/80 leading-relaxed">
                      <strong>Disclaimer:</strong> This is an AI-assisted prediction, not a medical
                      diagnosis. Always consult a qualified doctor before any treatment.
                    </div>
                  </motion.div>
                )}
              </AnimatePresence>
              ...
              <div className="glass rounded-3xl p-6 sticky top-28">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-display font-bold text-medical-dark flex items-center gap-2">
                    <Clock className="h-4 w-4 text-medical-light" /> Detection history
                  </h3>
                  {history.length > 0 && (
                    <button
                  ...
                  <div className="space-y-3 max-h-[60vh] overflow-y-auto pr-1">
                    {history.map((h) => (
                      <motion.div
                        ...
                        className="flex gap-3 p-3 rounded-2xl bg-white border border-border hover:border-medical-light transition"
                      >
                        <img
                          src={h.image}
                          alt=""
