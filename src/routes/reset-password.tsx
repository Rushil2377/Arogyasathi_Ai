      ...
      <div className="hidden lg:flex relative gradient-medical text-white p-12 flex-col justify-between overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-3 text-white/85 max-w-md">
            Update your password to regain access to your smart healthcare companion.
          </p>
        </div>
          ...
          {!sessionChecked ? (
            ...
            <div className="text-center space-y-6 flex flex-col items-center">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Your password has been changed successfully. Redirecting you to the login screen in
                a few seconds...
              </p>
            ...
            <>
              <h2 className="font-display text-3xl font-bold text-medical-dark">
                Create new password
              </h2>
